...
class DiaryAdapter(private val context: Context) : RecyclerView.Adapter<DiaryAdapter.DiaryViewHolder>() {
    private var diaries: List<Diary> = listOf() // 초기화된 빈 리스트로 시작
    inner class DiaryViewHolder(itemView: View, private val binding: ItemDiariesBinding):RecyclerView.ViewHolder(itemView){
    ...
    override fun onCreateViewHolder(
        ...
        val binding = ItemDiariesBinding.inflate(LayoutInflater.from(context), parent, false)
